        ...
        <div class="col-12 mb-3">
          <div class="publication-list-item" onclick="openPublicationModal('j10')" style="cursor: pointer;">
            ...
            <div class="external-links">
              ...
              <a href="https://oshmos.github.io/BPPC/" target="_blank" class="external-icon-link website-link" title="Project Page" onclick="event.stopPropagation()">
                <i class="fas fa-globe"></i>
              </a>
              <a href="https://github.com/OSHMOS/BPPC" target="_blank" class="external-icon-link github-link" title="GitHub" onclick="event.stopPropagation()">
                <i class="fab fa-github"></i>
              </a>
            </div>
...
{% include publication_modals.html %}
